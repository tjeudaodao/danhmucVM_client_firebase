...
{
    class ketnoisqlite_data
    {
        #region khoitao
        public static SQLiteConnection connec = null;
        public ketnoisqlite_data()
        {
        ...
        private static ketnoisqlite_data _khoitao = null;
        public static ketnoisqlite_data khoitao()
        {
            if (_khoitao == null)
            {
                _khoitao = new ketnoisqlite_data();
            }
            return _khoitao;
        }
        ...
        public bool kiemtraCot(string tencot)
        {
            string sql = string.Format("select {0} from hangduocban", tencot);
            bool kq = false;
            try
            {
                Open();
